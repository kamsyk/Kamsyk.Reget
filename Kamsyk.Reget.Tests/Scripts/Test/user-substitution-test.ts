...
describe("User Substitution Controller", () => {
    let userSubstitutionController: Kamsyk.RegetApp.UserSubstitutionController;
    ...
    beforeEach(() => {
        ...
        userSubstitutionController = new Kamsyk.RegetApp.UserSubstitutionController(
            $scope,
            $http,
            $filter,
            $mdDialog,
    ...
    it("Is User AppMan", () => {
        //Arrange
        let approvers: Kamsyk.RegetApp.Participant[] = [];
        let appMan: Kamsyk.RegetApp.Participant = new Kamsyk.RegetApp.Participant();
        appMan.id = 1;
        appMan.surname = "test";
        ...
        //Act
        let part: Kamsyk.RegetApp.Participant = new Kamsyk.RegetApp.Participant();
        appMan.id = 1;
        appMan.surname = "test";
        userSubstitutionController.substitutedItemChange(part, null);

        //Asset
        let appMan0id: number = userSubstitutionController.approvers[0].id;
        expect(appMan0id).toEqual(1);
    });

    it("Is Row Changed", () => {
        //Arrange
        let origUserSubstitution: Kamsyk.RegetApp.UserSubstitution = new Kamsyk.RegetApp.UserSubstitution(
            0,
            1,
            4,
            new Date("2019-01-16"),
        ...
        let editUserSubstitution: Kamsyk.RegetApp.UserSubstitution = angular.copy(origUserSubstitution);
    ...
    it("Is New Substitution Valid", () => {
        ...
        let substitutedUser: Kamsyk.RegetApp.Participant = new Kamsyk.RegetApp.Participant();
        substitutedUser.id = 1;

        let substituteeUser: Kamsyk.RegetApp.Participant = new Kamsyk.RegetApp.Participant();
...
class UserSubstitutionAux {
    public getInitSubstitutionData(): Kamsyk.RegetApp.UserSubstitution[] {
        return [];
    }
