...
declare module angular.material {
    ...
    interface IBottomSheetOptions {
        templateUrl?: string;
        template?: string;
        scope?: ng.IScope; // default: new child scope
    ...
    interface IBottomSheetService {
        show(options: IBottomSheetOptions): ng.IPromise<any>;
    ...
    interface IPresetDialog<T> {
        ...
        scope(scope?: ng.IScope): T; // default: new child scope
        ...
        resolve(resolve?: { [index: string]: ng.IPromise<any> }): T;
    ...
    interface IDialogService {
        show(dialog: IDialogOptions | IAlertDialog | IConfirmDialog): ng.IPromise<any>;
        confirm(): IConfirmDialog;
        alert(): IAlertDialog;
        hide(response?: any): ng.IPromise<any>;
        cancel(response?: any): void;
    }

    interface IIcon {
        (id: string): ng.IPromise<Element>; // id is a unique ID or URL
    }
    ...
    interface IToastService {
        show(optionsOrPreset: IToastOptions | IToastPreset<any>): ng.IPromise<any>;
        showSimple(content: string): ng.IPromise<any>;
