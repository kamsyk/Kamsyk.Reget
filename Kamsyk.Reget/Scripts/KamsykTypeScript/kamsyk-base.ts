...
export abstract class KamsykBaseTs {
        ...
        public displayErrorMsg(errMsg?: string, warnTitle?: string, elementIdToHide?: string): void {
        ...
        public convertJsonDate(jsonDate: any): any {
        ...
        public isMomentDatesSame(date1: any, date2: any): boolean {
            try {
    ...
    public validateDecimalNumber(strDecimal: string, input: any): void {
