...
/// <reference path="../../Scripts/typings/kamsyk-material/angular-material.d.ts" />
...
var KamsykBaseTs = /** @class */ (function () {
    //**********************************************************************************
    //*****************************************************************
    //Constructors
    function KamsykBaseTs($scope, $http, $filter, $mdDialog, $mdToast, $q, $timeout
    ...
    //******************************************************************
    KamsykBaseTs.prototype.getRegetRootUrl = function () {
    ...
    KamsykBaseTs.prototype.showLoader = function (isError) {
        if (this.isValueNullOrUndefined(isError) || isError === false) {
            $(".reget-se-pre-con").show();
        }
    };
    KamsykBaseTs.prototype.showLoaderBoxOnly = function (isError) {
        if (this.isValueNullOrUndefined(isError) || isError === false) {
            $(".reget-se-pre-con-box-only").show();
        }
    };
    KamsykBaseTs.prototype.hideLoader = function () {
        $(".reget-se-pre-con").fadeOut();
        $(".reget-se-pre-con-box-only").fadeOut();
    };
    KamsykBaseTs.prototype.displayErrorMsg = function (errMsg, warnTitle, elementIdToHide) {
    ...
    KamsykBaseTs.prototype.showAlert = function (strTitle, strMsg, strCloseButtonLabel) {
    ...
    KamsykBaseTs.prototype.debounce = function (func, wait, immediate) {
        var timeout;
        return function () {
    ...
    KamsykBaseTs.prototype.isValueNullOrUndefined = function (value) {
        return RegetCommonTs.isValueNullOrUndefined(value);
    };
    KamsykBaseTs.prototype.isStringValueNullOrEmpty = function (strValue) {
        return RegetCommonTs.isStringValueNullOrEmpty(strValue);
    };
    KamsykBaseTs.prototype.getDateTimeString = function (dateVal) {
        return convertDateTimeToString(dateVal);
    };
    //private dialogController($scope, $mdDialog) {
    //    $scope.closeDialog = function () {
    //        $mdDialog.hide();
    //    }
    //}
    KamsykBaseTs.prototype.convertJsonDate = function (jsonDate) {
    ...
    KamsykBaseTs.prototype.isMomentDatesSame = function (date1, date2) {
        try {
    ...
    KamsykBaseTs.prototype.checkUserMandatorySelString = function (selectedUser, strErrorMsgId) {
    ...
    KamsykBaseTs.prototype.showToast = function (strText) {
        this.$mdToast.show(this.$mdToast.simple()
            .textContent(strText)
            .position('bottom center')
            .theme("success-toast"));
    };
    KamsykBaseTs.prototype.isSmartPhone = function () {
    ...
    KamsykBaseTs.prototype.displayElement = function (elementId) {
        $("#" + elementId).show();
    };
    KamsykBaseTs.prototype.hideElement = function (elementId) {
        $("#" + elementId).hide();
    };
    KamsykBaseTs.prototype.displayElementSlow = function (elementId) {
        $("#" + elementId).show("slow");
    };
    KamsykBaseTs.prototype.hideElementSlow = function (elementId) {
        $("#" + elementId).slideUp();
    };
    KamsykBaseTs.prototype.convertTextToDecimal = function (strNumber) {
        if (this.isStringValueNullOrEmpty(strNumber)) {
            return null;
        }
        var strDecimailSep = $("#DecimalSeparator").val();
        strNumber = strNumber.replace(strDecimailSep, ".");
        return parseFloat(strNumber);
    };
    KamsykBaseTs.prototype.isStringDecimalNumber = function (strDec) {
        var strDecimailSep = $("#DecimalSeparator").val();
        if (this.isStringValueNullOrEmpty(strDecimailSep)) {
            strDec = strDec.replace(strDecimailSep, ".");
        }
        var dParse = parseFloat(strDec);
        if (isNaN(dParse)) {
            return false;
        }
        return true;
    };
    KamsykBaseTs.prototype.validateDecimalNumber = function (strDecimal, input) {
    ...
    KamsykBaseTs.prototype.stopPropagation = function (event) {
        event.stopPropagation();
    };
    KamsykBaseTs.prototype.getAllUrlParams = function () {
        var keyPairs = [];
    ...
    KamsykBaseTs.prototype.removeDiacritics = function (str) {
        var _this = this;
...
exports.KamsykBaseTs = KamsykBaseTs;
...
exports.RegetCommonTs = RegetCommonTs;
//# sourceMappingURL=kamsyk-base.js.map