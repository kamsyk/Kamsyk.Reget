...
(function (Kamsyk) {
    ...
    (function (RegetApp) {
        ...
        var BaseRegetGridTranslationTs = /** @class */ (function (_super) {
            __extends(BaseRegetGridTranslationTs, _super);
            //public modifLocalTexts: LocalText[] = null;
            //*****************************************************************
            //*****************************************************************
            //Constructors
            function BaseRegetGridTranslationTs($scope, $http, $filter, $mdDialog, $mdToast, $q, uiGridConstants, $timeout
            ...
            //********************************************************************
            //********************************************************************
            BaseRegetGridTranslationTs.prototype.saveGridRowtoDb = function (rowEntity) {
            ...
            //*******************************************************************
            //Methods
            BaseRegetGridTranslationTs.prototype.displayGridTranslation = function (target) {
            ...
            BaseRegetGridTranslationTs.prototype.localtext1changed = function (strValue) {
            ...
            //    }
            //}  
            BaseRegetGridTranslationTs.prototype.localtext2changed = function (strValue) {
                if (this.isStringValueNullOrEmpty(strValue)) {
            ...
            //}
            BaseRegetGridTranslationTs.prototype.isTranslationValid = function () {
            ...
            BaseRegetGridTranslationTs.prototype.saveTranslation = function () {
                this.translateErrorMsg = null;
            ...
            BaseRegetGridTranslationTs.prototype.closeTranslation = function () {
                // this.revetTranslations();
                this.hideTranslation();
            };
            BaseRegetGridTranslationTs.prototype.hideTranslation = function () {
                var divTranslation = document.getElementById("divtranslatedirective");
            ...
            return BaseRegetGridTranslationTs;
        }(RegetApp.BaseRegetGridTs));
        RegetApp.BaseRegetGridTranslationTs = BaseRegetGridTranslationTs;
    })(RegetApp = Kamsyk.RegetApp || (Kamsyk.RegetApp = {}));
})(Kamsyk || (Kamsyk = {}));
//# sourceMappingURL=reget-base-grid-translation.js.map